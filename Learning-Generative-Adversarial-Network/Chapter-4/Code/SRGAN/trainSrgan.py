...
import cv2
# Only for running this code on remote machine Xwindow system.
#import matplotlib
#matplotlib.use('Agg')
...
#path to VGG19 pretrained model.Download and save the pre-trained model in this location
vgg_model = 'backup/vgg19/latest'
